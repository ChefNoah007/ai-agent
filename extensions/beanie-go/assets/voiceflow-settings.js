...
(function() {
  ...
  if (window.VOICEFLOW_SETTINGS) {
    ...
    console.warn('Voiceflow settings not found in window.VOICEFLOW_SETTINGS, creating with defaults');
